...
class IOUContract : Contract {
        ...
        when(command.value){
            is Commands.Create -> {
                requireThat {
                    ...
                    "IOU value should be properly calculated" using((command.value as Commands.Create).exchangeRate* (command.value as Commands.Create).iouValue == out.value)
                    "Currency used for exchange should be of same type" using ((command.value as Commands.Create).currency == out.currency)
    ...
    interface Commands : CommandData {
        ...
        class Create(val currency:String, val iouValue:Double,val exchangeRate:Double) : Commands
    }
}
